                ...
                line.addEventListener( "click",
                                        function (e)
                                        {
                                            ...
                                            line.className = "form_line_selected form_line";//we select the line that we clicked on
                                                ...
                                                // if(selected[line.id])//if the line was selected
                                                // {
                                                //     line.className = "form_line_unselected form_line";//we unselect it
                                                // }
                                                // else//if the line was not selected
                                                // {
                                                //     line.className = "form_line_selected form_line";//we select it
                                                // }                                   
                                        },
                                        true);
