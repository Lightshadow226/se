...
<body>
	...
	<div class = "main_content">
        <div class = "card-firstdiv add_padding">
			...
			<h2>What age does your child have to have to play?</h2>
			<p>Due to certain subject matter that will be present within the story, we recommend that players should be <b>over the age of 13 years old in order to play.</b></p><br>
			<p>The story centers around teenagers that are around the age of 15 to 18 years old, and thus, the story is written for an audience that fits this ideal age range. Adult characters within the Sweet Elite universe also play a role in the story.<p><br>

			<h2>Who are we?</h2> 
			<p>Sweet Elite is published by a Canadian game development company, Dulcet Games Inc., established in 2016. We are a team of young programmers, artists, writers and designers with a passion of good stories and games! You can contact us at <a href="mailto:contact@sweetelitegame.com?Subject=Business%20Inquiry" target="_top">contact@sweetelitegame.com</a></p><br>

			<h2>What do we look out for?</h2>
			...
			<p>Our recommendation: <a href=" https://www.getcybersafe.gc.ca">www.getcybersafe.gc.ca</a><p>
		</div>
	</div>
