...
function Chapter1()
{
    ...
    //story[0] === Story Text -> "null" will make the bar invisible
    story[0] = [
                    ...
                    "Nevermind that, [Scholar’s name]! You’re here; you’ve made it. Let’s just focus on getting these bags to my room.",
                    ...
                    "S-Sorry.",
                    "Y-Yeah, I’m [Scholar’s name]. Sorry about almost throwing us both to the ground...",
                    "(Next)",
                    "(Next)",//35
                    ...
                    "H-hi I’m [Scholar’s name]... (I extended my hand for him to shake.)",
                    ...
                    "(Next)",
                    "[Scholar’s name], I’m new here. Actually, I ran into a girl called Karolina who was looking for someone with your description. Do you know her?",//70
                    ...
                    "(Next)",
                    "[Scholar’s name].  Athletics department, then?",//100
                    ...
                    "Yeah… I just got here. I’m [Scholar’s name]",
                    "null",
                    "(Next)",
                    "Alright!",//110
                    "(Next)",
                    ...
                    "(Next)",
                    "(Next)",
                    "Well, I’m kinda new here and I was just looking around the place, sorry if I interrupted you or anything. I’m [Scholar’s name], by the way.",
                    "(Next)",//125
    ...
    story[1] = [
                    ...
                    "Nice to meet you [Scholar’s name]! I’m Ellie [Surname], president of the robotics club.",
                    ...
                    "…",
                    "null",
                    "I-It’s alright, I was just looking through the school’s medical herbs. Pleased to meet you [Scholar’s name], I’m Claire.",//125
                    "null",
                    "null",
    ...
    story[5] = [
                    ...
                    locations.gym,
                    locations.gym,
                    locations.dorm,//165 //Illustrations
                    locations.dorm,//Illustrations
                    locations.dorm,//Illustrations
                    locations.gym,
                    locations.gym,
                    locations.gym,//170
    ...
    //story[6] === Special Option: Specific state of this slide
        ...
        -7 -> Customize character interface
        */
    story[6] = [
                    -1,//0
                    -1,
                    ...
                    -1,
                    -1,
                    -2,//ulimited navigation does not work until next slide. You have to put -2 on the slide before so it works
                    -1,//10
                    -1,
                    -1,
                    -1,
    ...
    //story[10] === Choice 1 Link -> "-1"is no link, otherwise the number represents the array number of the slide
        ...
        x > 0 -> number represents the array number of the slide to go to
            ...
            -3 -> Special form (Choose your department)
            -4 -> Enable Choice of Romance & Friendship
            -5 -> Enable multiple choices (Max 3)
            -6 -> we look at past links (we enable variables 18 & 19)
        */
    story[10] = [
                    -1,//0
