...
$(function create_interface()
{
    ...
    var main_10_button = document.createElement('div');//de 0 à 9
        ...
        main_10_button.addEventListener("click", function(e){refresh_lines(0, qty_main_10);})
    ...
    var classmates_button = document.createElement('div');
        ...
        classmates_button.addEventListener("click", function(e){refresh_lines(qty_main_10, qty_main_10 + qty_classmates);})
