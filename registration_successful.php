...
<body class= "center-screen">
		...
		<div class = "">
			<div class="card-nomargin add_padding">
				...
				<p style="text-align:center;"> It may take several minutes for you to receive the email. If it doesn't show up in your inbox, check your spam or junk folder. Some email providers don't think we're popular enough for your normal inbox. :(</p><br>
